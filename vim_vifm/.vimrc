...
map <leader>ll :w<CR>:Start! xelatex -pdf -xelatex="pdflatex --shell-escape \%O \%S" % && latexmk -c %<CR>
...
"delete lines with html/markdown comments
:nnoremap -rmcl :g/<!\|-->/d


"delete lines with "[comment]:"
...
"***
"pdfnote to Remark comments
"
":nmap -pd2rm :%s/\\pdfnote{\(.\+\)}/\?\?\? \r\1/gc
:nmap -pd23m %s/\\pdfnote{\(\_.\{-}\)}/\r\?\?\?\r\1/gc

"Four hashes -- needs a {-} for unnumbered
:nmap -u4h g/^####\C/v/{-}/s/$/{-}

"three hashes -- needs a {-} for unnumbered
:nmap -u3h g/^###\C/v/{-}/s/$/{-}

" Slides separated by --- always
" %s/^##/#/gc
